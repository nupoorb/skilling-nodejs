...
describe('Service', function(){
    ...
    it('tests userExists not found',async function () {
     ...
     it('tests view loans',async function () {
        const callback = sinon.stub(service, 'getLoan').returns(userid);
        await service.viewLoans(userid);
        sinon.assert.calledWith(callback, userid);
    })
});
